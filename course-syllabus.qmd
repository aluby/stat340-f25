...
I offer the opportunity to submit exam revisions for two reasons: (1) to correct any major misunderstandings and have a chance to revisit material that you struggled with, (2) to mitigate the impact that a bad exam day can have on your final course grade. You can submit corrections to your exam to earn back 50% of your missed points. Corrected exam grades are capped at 88%. Exam revisions are due 1 week after graded exams are returned to you, or the last day of class at 11:59pm, whichever is earlier.

## Missing homework quizzes and exams

There are no makeup homework quizzes.

If you miss a class when there is an exam and don’t make arrangements with me at least a week in advance, then there are no makeups offered. If must miss an exam due to an illness or other last minute emergency, please let me know in advance to arrange an alternative.
...
The use of the [R](https://cran.rstudio.com/) programming language, with the [RStudio](https://posit.co/download/rstudio-desktop/) interface is an essential component of this course. Bayesian Statistics is computationally intense, and so you will need to install local versions of the software on your own computer, or plan to complete assignments on a lab computer.
